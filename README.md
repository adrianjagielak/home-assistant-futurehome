...
* Exposes the Futurehome house mode (Home/Away/Sleep/Vacation) — the mode changed by the [Futurehome Modeswitch](https://www.futurehome.io/en_no/shop/modeswitch-white) — as a `Mode` selector on the Smarthub device, and keeps it in sync in real time.
...
| Button | [scene_ctrl](https://github.com/adrianjagielak/home-assistant-futurehome/blob/master/futurehome/src/services/scene_ctrl.ts) | [Modusbryter](https://www.futurehome.io/en_no/shop/modeswitch-white) | ✅ | [Event](https://www.home-assistant.io/integrations/event/), [Sensor](https://www.home-assistant.io/integrations/sensor/), [Select](https://www.home-assistant.io/integrations/select/) |
